...
/**
 * Created by aho on 2017/3/28.
 */

public class RetrofitMultipartUtil {
    private static RetrofitMultipartUtil retrofitMultipartUtil = null;

    static {
        if (retrofitMultipartUtil == null) {
            retrofitMultipartUtil = new RetrofitMultipartUtil();
        }
    }

    private RetrofitMultipartUtil() {
    }
