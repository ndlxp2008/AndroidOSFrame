...
public class RxBus {
     ...
     * @return
     */
    public RxBus OnEvent(Flowable<?> mFlowable, Consumer<Object> mConsumer) {
        mFlowable.observeOn(AndroidSchedulers.mainThread()).subscribe(mConsumer, new Consumer<Throwable>() {
            @Override
